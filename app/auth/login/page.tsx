      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-[var(--border)]">
          ...
          <div className="space-y-4">
            ...
            >
              {loading ? (
                <div className="w-5 h-5 border-2 border-[var(--neutral-800)] border-t-transparent rounded-full animate-spin" />
              ) : (
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-2 text-[var(--neutral-600)]">
                  또는 이메일로 로그인
                </span>
              </div>
            </div>
          ...
          <div className="mt-6 text-center text-sm text-[var(--neutral-600)]">
            계정이 없으신가요?{" "}
            <Link
              href="/auth/signup"
